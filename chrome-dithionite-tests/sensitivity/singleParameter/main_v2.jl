...
logoffset = 1 # min an max of base value
...
soltype = "external"
simbasename = "1d-allReactions-10m-uniformVelocity-tol"
startover = "false"
...
for sensparam in sensparams
    ...
    smallparams = collect(linspace(logparams_init[iparamloc]-logoffset,logparams_init[iparamloc],nstops+1)[1:end-1])
    largeparams = collect(linspace(logparams_init[iparamloc],logparams_init[iparamloc]+logoffset,nstops+1)[2:end])
