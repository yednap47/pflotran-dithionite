...
timeunits = sachFun.readObsHeaders("s2o4-fe3_s2o4-disp-obs-0.tec")[1]
...
plt.tight_layout()
plt.savefig("s2o4-fe3_s2o4-disp.png")
plt.close()
# 
# Compare with simulation witout disproportionation
myvar = [
"pH",
"Total S2O4-- [M]",
"Fe(OH)3(s) VF",
...
ax2[2][:plot]([0,0],[0,0],color="red",linestyle="--",label="No disproportionation")
...
ax2[2][:plot]([0,0],[0,0],color="blue",linestyle="--",label="With disproportionation")
...
plt.savefig("s2o4-fe3_s2o4-disp_compare.png")
